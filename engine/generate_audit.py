...
a("Phase 3: Agent narrates 28 non-trivial cases (Groq, llama-3.3-70b)")
...
if nex.get("explanation"):
    a("**Phase 3 explanation:** %s" % nex["explanation"][:250])
a("")
...
if e2 and e2.get("explanation"):
    a("| Phase 3 | %s... |" % e2["explanation"][:120])
...
if nex.get("explanation"):
    a("| Phase 3 | %s... |" % nex["explanation"][:120])
