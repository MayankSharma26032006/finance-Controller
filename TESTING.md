...
**57 tests** across 12 test classes, covering the critical financial-reconciliation paths:
...
- **Unit tests (Classes 1-9, 11-12):** Test individual functions with small controlled fixtures. Fast, deterministic, no file I/O against real data.
- **Integration tests (Class 10):** Run the full deterministic matcher against the frozen `data/raw/` CSV files. Verifies the complete pipeline produces correct counts without errors.
